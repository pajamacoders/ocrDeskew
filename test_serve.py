...
def correct_direction_and_visualize(data, logit, logger, deskew_deg):
    degrees = [-90,0,90,180]
...
if __name__ == "__main__":
    ...
    mltracker = MLLogger(orientation_cfg, logger)
    data_root = "/home/train_data_v2/valid/*"#'./test_file/*'
    ...
    for impath in tqdm(imgs):
        ...
        correct_direction_and_visualize(data, out, mltracker, -rotation)
