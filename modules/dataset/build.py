...
def build_dataloader(type, train_batch, valid_batch, train, valid, augment_fn):
    ...
    train_loader = DataLoader(train_dataset, batch_size=train_batch, shuffle=(sampler is None), sampler=sampler, num_workers=4)
    valid_loader = DataLoader(valid_dataset, batch_size=valid_batch, shuffle=True, num_workers=4)
