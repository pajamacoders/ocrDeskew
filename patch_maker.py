...
if __name__ == '__main__':
    ...
    # load data
    img_pathes = glob(os.getcwd()+'/need_to_be_check_files/*', recursive=True)
    # random.shuffle(img_pathes)
    #img_pathes=['samples/account1_140.png']
    for k, image_path in enumerate(img_pathes):
        ...
        bboxes= test_net(net, image, args.text_threshold, args.link_threshold, args.low_text, args.cuda, args.poly, refine_net)
        ...
        #file_utils.savePatches(image_path, image[:,:,::-1], polys, dirname=result_folder)
